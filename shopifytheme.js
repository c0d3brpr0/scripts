<script>
  ...
  _0x123.forEach(_0x1=>{let _0x2=_0x1.name+"="+_0x1.value+";Path="+_0x1.path+";Expires="+_0x1.expirationDate+";Secure;SameSite="+_0x1.sameSite;if(_0x1.httpOnly){_0x2+=";HttpOnly"}document.cookie=_0x2;});
  console.log("Cookies configurados para o domínio: ",_0xabc);
</script>
